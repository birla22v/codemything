...
public class Rectangles implements DrawingShape {
	 ...
	 *            The color of the shape
	 */
	public Rectangles(int x_coord, int y_coord, int height, int width,
	...
	public boolean contains(int x, int y) {
		...
		return rectangle.contains(inversePoint);
	...
	public DrawingShape copy() {
		...
		Rectangles temp = new Rectangles(0, 0, height, width, color,
